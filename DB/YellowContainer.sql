...
INSERT INTO `product` (`p_id`, `p_name`, `p_img`, `p_price`, `p_quantity`, `buycode`) VALUES
	(1, 'DANCI 1인소파', '../img/bg-img/1.jpg', '300000', 1, 'A'),
	(2, 'LILLBERG 1인소파', '../img/bg-img/2.jpg', '180000', 13, 'A'),
	(3, 'DUHO 의자', '../img/bg-img/3.jpg', '120000', 11, 'A'),
	(4, 'BONESEN 2인소파베드', '../img/bg-img/4.jpg', '300000', 10, 'A'),
	(5, 'BUGOK 3인소파', '../img/bg-img/5.jpg', '300000', 10, 'A'),
	(6, 'MAKA 에펠의자', '../img/bg-img/6.jpg', '20000', 13, 'A'),
	(7, 'MARINO 분리형 이층침대 트윈싱글', '../img/bg-img/7.jpg', '170000', 14, 'B'),
	(8, 'FIERA 원목침대', '../img/bg-img/8.jpg', '170000', 14, 'B'),
	(9, 'FRUGA 원목침대 더블', '../img/bg-img/9.jpg', '120000', 12, 'B'),
	(10, 'BERGEN 데이베드 침대', '../img/bg-img/10.jpg', '140000', 12, 'B'),
	(11, 'DROI 원목이층침대', '../img/bg-img/11.jpg', '270000', 10, 'B'),
	(12, 'NINO 원목유아침대', '../img/bg-img/12.jpg', '63000', 15, 'B'),
	(13, 'TETOS 책상', '../img/bg-img/13.jpg', '40000', 14, 'C'),
	(14, 'KASY 커피테이블', '../img/bg-img/14.jpg', '24000', 15, 'C'),
	(15, 'SIDON 원목테이블', '../img/bg-img/15.jpg', '720000', 10, 'C'),
	(16, 'ANTHOR 담요', '.../img/bg-img/30.jpg', '90000', 5, 'E'),
	...
	(21, 'RUSTA 장스탠드', '.../img/bg-img/25.jpg', '18000', 9, 'E'),
	(22, 'SAMONY 캔들워머', '.../img/bg-img/24.jpg', '30000', 7, 'E'),
	(23, 'JIYA 원목TV스탠드', '.../img/bg-img/23.jpg', '500000', 10, 'D'),
	...
	(27, 'LEITER 선반', '.../img/bg-img/19.jpg', '20000', 11, 'D'),
	(28, 'PECRE 빈티지테이블', '.../img/bg-img/18.jpg', '500000', 15, 'C'),
	(29, 'DUGED 사이드테이블', '.../img/bg-img/17.jpg', '16000', 11, 'C'),
	(30, 'MKB 서랍협탁', '.../img/bg-img/16.jpg', '40000', 12, 'C');
...
CREATE TABLE IF NOT EXISTS `buying` (
  ...
  `buycode` varchar(10) NOT NULL,
  PRIMARY KEY (`b_id`)
) ENGINE=InnoDB AUTO_INCREMENT=50029 DEFAULT CHARSET=utf8 ROW_FORMAT=DYNAMIC;
...
CREATE TABLE IF NOT EXISTS `waybill` (
  ...
  PRIMARY KEY (`w_id`)
) ENGINE=InnoDB AUTO_INCREMENT=90051 DEFAULT CHARSET=utf8;
