	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<div class="mobile-nav">
			...
			<div class="amado-navbar-brand">
				<a href="OrdersProcServlet?action=index"><img
		...
		<li class="active"><a
			href="WaybillProcServlet?action=waybilllist&page=1">운송내역</a></li>
			...
			<div class="row">
				<div style="width: 100%; position: relative;">
					...
					<div align="left" style="position: relative;">
						<button type="button"
							onclick="location.href='WaybillProcServlet?action=shipping&add=A'">경기권</button>
						<button type="button"
							onclick="location.href='WaybillProcServlet?action=shipping&add=B'">충청권</button>
						<button type="button"
							onclick="location.href='WaybillProcServlet?action=shipping&add=C'">전라권</button>
						<button type="button"
							onclick="location.href='WaybillProcServlet?action=shipping&add=D'">경상권</button>
						<button type="button"
							onclick="location.href='WaybillProcServlet?action=shipping&add=E'">강원도</button>

						<div
							style="float: right; padding-bottom: 10px; position: relative;">
							<form action="WaybillProcServlet?action=selectShipping"
