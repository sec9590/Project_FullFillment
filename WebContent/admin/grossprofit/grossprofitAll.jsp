...
<script type="text/javascript">
	...
	function drawVisualization() {		
		var data = google.visualization.arrayToDataTable([
				[ '월별', '쇼핑몰', '구매처', '운송회사', '매출총이익' ],
				[ '2019/03', 12739000, 280000, 100000, 12359000],
				[ '2019/04', 92003000, 468000, 100000, 8632300],
				[ '2019/05', 36709100, 30976000, 300000, 5433100]
...
<body>
	...
	<div class="main-content-wrapper d-flex clearfix">
		...
		<li class="active"><a href="OrdersProcServlet?action=grossprofit">매출
				총 이익</a></li>
		</nav> </header>
		<!-- Header Area End -->
				...
				<div style="width: 100%; position: relative;">
					...
					<div align="left" style="position: relative;">
						...
						<div
							...
							<form action="OrdersProcServlet?action=selectGrossprofit"
								...
								<tbody>
									<tr>
										...
										<td style="color: blue"><fmt:formatNumber
												value="${requestScope.shoptotal}" pattern="#,###" /></td>
									</tr>
									<tr>
										<td>구매처 (-)</td>
										<td style="color: red"><fmt:formatNumber
												value="${requestScope.buyingtotal}" pattern="#,###" /></td>
									</tr>
									<tr>
										<td>운송 (-)</td>
										<td style="color: red"><fmt:formatNumber
												value="${requestScope.shiptotal}" pattern="#,###" /></td>
									</tr>
									<tr class="success">
										<td>총 이익</td>
										<td style="font-weight: bold"><fmt:formatNumber
												value="${requestScope.shoptotal - requestScope.buyingtotal - requestScope.shiptotal}"
												pattern="#,###" /></td>
									</tr>
								</tbody>
							</table>
